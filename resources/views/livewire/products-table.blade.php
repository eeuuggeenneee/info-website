                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input wire:model.debounce.300ms="search" name="search" id="searchname" type="text"
                        ...
                        <div>
                            ...
                            <div class="block mt-2">
                                <span class="flex items-center">
                                    <img src="../../assets/images/shop/items/s1.html"
                            ...
                            <div class="block mt-2">
                                <span class="flex items-center">
                                    <img src="../../assets/images/shop/items/s2.html"
                                        class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                    <span class="ms-3">
                            ...
                            <div class="block mt-2">
                                <span class="flex items-center">
                                    <img src="../../assets/images/shop/items/s3.html"
                                        class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                    <span class="ms-3">
                        ...
                        <div class="mt-2">
                            <input type="submit"
                                class="py-2 px-5 inline-block tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full"
                                value="Apply Filter">
                        </div>
                    </div>
                </form>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ route('details', ['id' => $product->id]) }}"
                                    class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-slate-900 border-slate-900 text-white w-full rounded-md">View
                                    Item</a>
                            </div>
                        ...
                        <ul class="inline-flex items-center -space-x-px">
                            ...
                            <li>
                                <a wire:click.prevent="gotoPage(1)"
                                    class="w-[40px] h-[40px] inline-flex justify-center items-center text-svlate-400 hover:text-white bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-700 hover:border-indigo-600 dark:hover:border-indigo-600 hover:bg-indigo-600 dark:hover:bg-indigo-600">First</a>
                            </li>
